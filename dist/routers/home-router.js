...
var home_router_exports = {};
__export(home_router_exports, {
  default: () => home_router_default
});
module.exports = __toCommonJS(home_router_exports);
...
var postSchema = import_joi.default.object({
  url: import_joi.default.string().uri().required(),
  description: import_joi.default.string().allow("")
});

// src/routers/home-router.ts
var import_express = require("express");
var homeRouter = (0, import_express.Router)();
